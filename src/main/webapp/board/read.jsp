...
<table class="tb1" border="0">
	<tr>
		<td colspan='6' style="background-color: #ff5050; color: white; text-align: center">자유 게시글</td>
	<tr>
	<tr>
		<th>제목</th>
	...
	<tr height="200">
		...
		<img src="http://172.16.4.75:9090/boardimg/${dto.filename }" width="100%">
		</c:if>
	  	</td>
	</tr>
...
$("#rcmbtn").click(function(){  
	$.post("/hotsource/board/recommend.do",
			"boardno=" + $("#boardno").val(),
			responseProc);
}); //recommend() end
...
$("#replycreate").click(function(){  
	...
	$.post("/hotsource/board/replycreate.do", params, responseProc);
}); //replycreate() end 
...
function replydel(rno) {
	...
	$.post("/hotsource/board/replydelete.do",
			params, responseProc);
}
