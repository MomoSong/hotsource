...
<table class="tb1" border="0">
	<tr>
		<td colspan='2' style="background-color: #ff5050; color: white; text-align: center">FAQ 게시글 수정</td>
	<tr>
	<tr>
		<th>제목</th>
	...
	<tr height="200">
		<th>답변</th>
		<td height="100"><textarea name="answer" rows="10" style="border: 1px solid #dcdcdc; width:100%;">${dto.answer }</textarea></td>
	</tr>
	...
	<tr>
		...
		<img src="./faq_storage/${dto.filename }" width="20%">
		</c:if>
		</td>
	</tr>
</table>
