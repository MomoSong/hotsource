...
<table class="tb1" border="0">
	<tr>
		<td colspan='2' style="background-color: #ff5050; color: white; text-align: center">ISSUE 게시글 수정</td>
	<tr>
	<tr>
		<th>제목</th>
	...
	<tr>
		...
		기존 파일 : ${dto.c_filename }<br>
		<c:if test="${dto.c_filesize>0 }">
		<img src="./i_storage/${dto.c_filename }" width="20%">
		</c:if>
		</td>
	</tr>
</table>
