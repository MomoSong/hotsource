...
<c:forEach var="dto" items="${list }">
	<tr>
		...
		<a href="./read.do?noticeno=${dto.noticeno }">${dto.title }</a> <span style="font-size : 15px;">(${dto.replycnt })</span>
		</td>
...
<div class="bottom" align="center">
	<input type="button" value="공지등록" onclick="location.href='./create.do'">
</div>
