...
<c:forEach var="dto" items="${list }">
	<tr>
		...
		<a href="./read.do?boardno=${dto.boardno }">${dto.title }</a> <span style="font-size : 15px;">(${dto.replycnt })</span>
		</td>
		<td>${dto.id }</td>
...
<div class="bottom" align="center">
	<input type="button" value="게시글 등록" onclick="location.href='./create.do?boardno=${dto.boardno }'">
	<input type="button" value="게시글 목록" onclick="location.href='../qboard/list.do'">
</div>
